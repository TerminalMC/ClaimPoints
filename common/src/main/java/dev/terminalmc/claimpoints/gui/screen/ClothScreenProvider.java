...
public class ClothScreenProvider {
    ...
    static Screen getConfigScreen(Screen parent) {
        ...
        ConfigCategory cp = builder.getOrCreateCategory(localized("option", "waypoints"));

        cp.addEntry(eb.startStrField(
                        localized("option", "waypoints.nameFormat"),
                ...
                .setErrorSupplier(val -> {
                    if (val.contains("%d"))
                        ...
                        return Optional.of(localized("option", "waypoints.nameFormat.error"));
                })
                .setSaveConsumer(var -> config.cpSettings.nameFormat = var)
                .build());

        cp.addEntry(eb.startStrField(
                        localized("option", "waypoints.alias"),
                ...
                .setErrorSupplier(val -> {
                    if (!val.isEmpty() && val.length() < 3)
                        ...
                        return Optional.of(localized("option", "waypoints.alias.error"));
                })
                .setSaveConsumer(var -> config.cpSettings.alias = var)
                .build());

        cp.addEntry(eb.startDropdownMenu(
                        localized("option", "waypoints.color"),
                        config.cpSettings.color,
                        String::valueOf
                )
        ...
        ConfigCategory gp = builder.getOrCreateCategory(localized("option", "griefprevention"));

        gp.addEntry(eb.startStrField(
                        localized("option", "griefprevention.command"),
        ...
        gp.addEntry(eb.startStrField(
                        localized("option", "griefprevention.firstPattern"),
        ...
        gp.addEntry(eb.startStrField(
                        localized("option", "griefprevention.claimPattern"),
        ...
        gp.addEntry(eb.startStrList(
                        localized("option", "griefprevention.endingPattern"),
        ...
        gp.addEntry(eb.startStrList(
                        localized("option", "griefprevention.ignoredPattern"),
        ...
        ConfigCategory ac = builder.getOrCreateCategory(localized("option", "autocommands"));

        ac.addEntry(eb.startIntSlider(
                        localized("option", "autocommands.commandDelay"),
                        config.acSettings.commandDelay,
                        1,
                        60
                )
        ...
        ac.addEntry(eb.startStrList(
                        localized("option", "autocommands.servers"),
        ...
        ac.addEntry(eb.startStrList(
                        localized("option", "autocommands.commands"),
