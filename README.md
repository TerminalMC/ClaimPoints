...
<img alt="Icon" width=100 src="./common/src/main/resources/assets/claimpoints/icon.png">

## ClaimPoints

Integrates with [Xaero's Minimap](https://modrinth.com/project/1bokaNcj) and the
[GriefPrevention](https://modrinth.com/project/O4o4mKaq) server plugin to allow semi-automatic
tracking
of claims using waypoints.
...
[![Available on Modrinth](https://img.shields.io/modrinth/dt/dyuTci89?label=Available%20on%20Modrinth&logo=modrinth&logoColor=%2300AF5C)](https://modrinth.com/project/dyuTci89)
[![Available on CurseForge](https://img.shields.io/curseforge/dt/1049887?label=Available%20on%20CurseForge&logo=curseforge)](https://curseforge.com/minecraft/mc-mods/claimpoints)
[![Available on GitHub](https://img.shields.io/github/downloads/TerminalMC/ClaimPoints/total?label=Available%20on%20GitHub&logo=github&logoColor=white)](https://github.com/TerminalMC/ClaimPoints)

</center></div>

### About

- This is a client-side mod, so it does not allow you to create or edit claims, only allows easy
  visualization of where your existing claims are.

- Use `/cp help` in-game for command info.

- If, when running the `/cp` commands, the GriefPrevention claim list shows up in chat, you will
  need to edit the regex patterns in the config to allow the mod to correctly capture the claim
  list.
...
Fabric: [Xaero's Minimap](https://modrinth.com/project/1bokaNcj), [Fabric API](https://modrinth.com/project/P7dR8mSH), [ModMenu](https://modrinth.com/project/mOgUt4GM), [Cloth Config API](https://modrinth.com/project/9s6osm5g)

NeoForge: [Xaero's Minimap](https://modrinth.com/project/1bokaNcj), [Cloth Config API](https://modrinth.com/project/9s6osm5g)
...
[![Issues](https://img.shields.io/github/issues/TerminalMC/ClaimPoints?logo=github&label=GitHub%20Issues)](https://github.com/TerminalMC/ClaimPoints/issues)

[![License](https://img.shields.io/github/license/TerminalMC/ClaimPoints?label=License&logo=github&logoColor=white)](https://github.com/TerminalMC/ClaimPoints/blob/HEAD/LICENSE.txt)
